      ...
      questions: [
        {
          ...
          answer: (
            <div className="space-y-2">
              <p>
                SageCombat is a competitive skill-based gaming platform that lets you compete with others using your market knowledge, without risking actual money in the stock market.
              </p>
              <p>
