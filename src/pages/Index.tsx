...
const Index = () => {
  ...
  const stats = [
    ...
    { icon: TrendingUp, value: "₹2.5M+", label: "Prizes Won" },
    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-grow">
        ...
        <section className="relative overflow-hidden pt-24 pb-12 md:pt-32 md:pb-20">
          ...
          <div className="absolute top-40 right-20 w-72 h-72 bg-gold-200/30 rounded-full blur-3xl animate-bounce -z-10" style={{animationDuration: '6s'}} />
            ...
            <div className="flex flex-col items-center text-center max-w-5xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 mb-8 w-full justify-center animate-fade-in">
                ...
                <a
                  ...
                  className="relative inline-flex items-center px-4 py-2 rounded-full border border-border transition-all duration-300 cursor-pointer animate-fade-in shadow-sm overflow-hidden bg-gradient-to-r from-slate-900 to-slate-800 hover:from-slate-800 hover:to-slate-700"
                >
              ...
              <h1 className="font-display text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight mb-8 animate-fade-up">
                ...
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary via-mint-600 to-gold-500 animate-gradient">
                  Fantasy Gaming
                </span>
              </h1>
              ...
              {/* CTA Buttons */}
              <div className="flex flex-col sm:flex-row gap-4 mb-16 w-full sm:w-auto animate-fade-up" style={{animationDelay: '400ms'}}>
                ...
                <Button 
                  variant="outline" 
                  size="lg" 
                  className="w-full sm:w-auto rounded-full px-8 py-4 text-lg border-2 hover:bg-accent/50 transform hover:scale-105 transition-all duration-300"
                  onClick={() => {
              ...
              {/* Stats */}
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 w-full max-w-2xl animate-fade-up" style={{animationDelay: '600ms'}}>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              {howItWorksSteps.map((step, index) => (
                <div 
                  key={index} 
                  className="relative text-center animate-fade-up group hover:scale-105 transition-transform duration-300"
            ...
            <div className="text-center mt-12">
              <Link to="/competitions">
                <Button size="lg" className="rounded-full px-8 animate-fade-up" style={{animationDelay: '800ms'}}>
        ...
        <section className="py-24 relative overflow-hidden">
          ...
          <div className="container px-4 mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {[
                { icon: Zap, title: "Instant Rewards", desc: "Get paid immediately when you win competitions" },
                { icon: Shield, title: "100% Safe", desc: "No real trading risk - pure skill-based predictions" },
                { icon: TrendingUp, title: "Real Market Data", desc: "Compete using live data from major exchanges" },
                { icon: Users, title: "Active Community", desc: "Join thousands of active prediction enthusiasts" },
                { icon: CheckCircle2, title: "Easy to Start", desc: "Simple registration with Google or phone number" },
                { icon: Star, title: "Fair & Transparent", desc: "Clear rules and transparent prize distribution" }
              ].map((feature, index) => (
                <div 
                  key={index}
                  className="text-center p-6 rounded-2xl bg-white/30 backdrop-blur-sm border border-white/20 hover:bg-white/40 transition-all duration-300 animate-fade-up group hover:scale-105"
