        ...
        <section className="py-16">
          <div className="container px-4 md:px-6 mx-auto">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-muted-foreground mb-6">Founded in 2025, SageCombat has quickly grown to become a leading platform for fantasy stock trading competitions. We are headquartered in New York City with a distributed team of financial experts and developers around the world.</p>
