  ...
  const teamMembers = [
    {
      ...
      bio: "ex - Amazon, Adobe. Driving SageCombat technical vision. He’s built scalable systems and led innovative projects, bringing expertise in full-stack development and a passion for gamified solutions.",
      linkedin: "https://www.linkedin.com/in/arpitdhamija/",
      image: "https://media.licdn.com/dms/image/v2/D5603AQHCBIxsDObHHg/profile-displayphoto-crop_800_800/B56Zm9wUr0J4AI-/0/1759825188686?e=1763596800&v=beta&t=U760TU4SXq59tE_L1wb_HKmruucfdE51XjOIltqoZl8"
    },
    {
      name: "Yuvraj Gosain",
      role: "Co-Founder",
        ...
        <section className="py-16 bg-secondary/20">
          <div className="container px-4 md:px-6 mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 max-w-4xl mx-auto">
              {teamMembers.map((member, i) => <MorphCard key={i} className="p-8 bg-background shadow-lg rounded-lg animate-fade-up hover:shadow-xl transition-shadow duration-300" style={{
                animationDelay: `${i * 150}ms`
              }}>
                  <img src={member.image} alt={`${member.name} profile`} className="w-24 h-24 rounded-full mx-auto mb-6 object-cover" />
                  ...
                  <a href={member.linkedin} target="_blank" rel="noopener noreferrer" className="flex justify-center">
